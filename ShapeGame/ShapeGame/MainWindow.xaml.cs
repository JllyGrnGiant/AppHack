...
namespace ShapeGame
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const int MaxShapes = 15;
        ...
        private const double DefaultDropSize = 80;
        private const double DefaultDropGravity = 0.7;
        ...
        private void HandleGameTimer(int param)
        {
            ...
            for (int i = 0; i < NumIntraFrames; ++i)
            {
                ...
                {
                    HitType hit = this.myFallingThings.LookForHits(pair.Value.Segments, pair.Value);
            ...
            this.myFallingThings.DrawFrame(this.playfield.Children, players);
            foreach (var player in this.players)
            {
